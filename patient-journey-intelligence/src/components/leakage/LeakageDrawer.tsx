    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
        <MetricBox
          ...
          value={formatNumber(data.patients_affected)}
          valueColor="var(--color-danger)"
        />
        <MetricBox
          icon={<TrendingDown size={14} />}
          label="Stage Drop-off Rate"
          value={formatPercent(data.dropoff_rate)}
          valueColor="var(--color-danger)"
        />
        <MetricBox
          icon={<Clock size={14} />}
          label="Avg Stage Delay"
          value={formatDays(data.avg_stage_duration_days)}
        />
        <MetricBox
